...
│       └── ...│   ├── sources/                          # Point-in-time Web Citations (S-001 .. S-073)
│   ├── index.md                      # Snapshot manifest & hash table
│   ├── docs/                         # Official developer docs (01..46, 60..73 append-only)
│   ├── google/                       # Google Cloud & SDK repos (47..51)
│   ├── protocol/                     # Protocol specifications (52)
│   └── community/                    # Third-party reverse engineering (53..59)
│
...
| [R-002](R-002-schema-coverage-audit.md) | Schema Coverage Audit: Antigravity Native Config Surface vs the 19-Schema Catalog | Complete | 2026-08-14 | Schema Catalog Coverage, Hooks Event Shapes, Rules & Workflows Frontmatter, MCP Transport Contracts | §1, §4, §5, §18, §20 | EV-010, EV-013, EV-014, EV-019, EV-020 |
| [R-003](R-003-rule-frontmatter-format.md) | Rule File Frontmatter Format: activation vs trigger vs none — verified against real Antigravity rule files | Complete | 2026-08-14 | Rule File Format, Frontmatter Keys (activation / trigger), Activation Modes & Glob Syntax, Auditor Rule Validation | §4, §5, §15, §17, §20 | EV-007 |
| [R-004](R-004-works-cited-minimization-audit.md) | Works Cited Minimization: every non-official source re-verified against the official docs (46 → 43 entries) | Complete | 2026-08-14 | Works Cited (§19), Source Classification (§2), Source Archive & Manifest Sync | §2, §19, §3.4, §16 | S-031, S-043 |
| [R-005](R-005-schema-verification-against-archived-ide-pages.md) | Schema verification against the archived IDE pages: hooks, rules, workflows (no changes required) | Complete | 2026-08-14 | HooksConfigSchema, RuleFileSchema, WorkflowFrontmatterSchema, IDE Docs (rules / workflows / hooks) | §4, §19, §20 | S-033, S-034, S-043 |
| [R-006](R-006-rule-and-workflow-live-inventory-audit.md) | Empirical Grounding: Rule Frontmatter, Glob Syntax, and Workflow Files across Live ~/.gemini Inventories | Complete | 2026-08-14 | RuleFileSchema, WorkflowFrontmatterSchema, Glob Syntax & Runtime Semantics, Live Workspace Rule & Workflow Inventories | §4, §15, §17, §20 | S-033, S-034, EV-007, EV-010 |
