...
category: docs
title: IDE MCP
url: "https://antigravity.google/docs/ide/mcp"
final_url: "https://antigravity.google/docs/ide/mcp"
fetched: 2026-08-14
status: 200
---
...
# Model Context Protocol (MCP)<a href="#model-context-protocol-mcp" class="deep-link-anchor" aria-label="Link to section">link</a>
...
## What is MCP?<a href="#what-is-mcp" class="deep-link-anchor" aria-label="Link to section">link</a>
...
### Add Context<a href="#add-context" class="deep-link-anchor" aria-label="Link to section">link</a>
...
### Add Custom Tools<a href="#add-custom-tools" class="deep-link-anchor" aria-label="Link to section">link</a>
...
## Antigravity 2.0<a href="#antigravity-20" class="deep-link-anchor" aria-label="Link to section">link</a>
...
## Antigravity IDE<a href="#antigravity-ide" class="deep-link-anchor" aria-label="Link to section">link</a>
...
## Antigravity CLI<a href="#antigravity-cli" class="deep-link-anchor" aria-label="Link to section">link</a>
...
### Interactive MCP Manager<a href="#interactive-mcp-manager" class="deep-link-anchor" aria-label="Link to section">link</a>
...
### Global and Workspace Server Configs<a href="#global-and-workspace-server-configs" class="deep-link-anchor" aria-label="Link to section">link</a>
...
## Antigravity SDK<a href="#antigravity-sdk" class="deep-link-anchor" aria-label="Link to section">link</a>
...
<div class="code-container" data-code-container="" data-clean-code="import asyncio
from google.antigravity import Agent, LocalAgentConfig" data-astro-cid-4g3kud3p="">

<div class="header" data-astro-cid-4g3kud3p="">

<span class="title caption" data-astro-cid-4g3kud3p="">python</span>
...
## MCP Configuration Structure<a href="#mcp-configuration-structure" class="deep-link-anchor" aria-label="Link to section">link</a>
...
### MCP Configuration Properties<a href="#mcp-configuration-properties" class="deep-link-anchor" aria-label="Link to section">link</a>
...
## MCP Authentication<a href="#mcp-authentication" class="deep-link-anchor" aria-label="Link to section">link</a>
...
### Google Credentials<a href="#google-credentials" class="deep-link-anchor" aria-label="Link to section">link</a>
...
<div class="code-container" data-code-container="" data-clean-code="gcloud auth application-default login" data-astro-cid-4g3kud3p="">
...
<div class="code-container" data-code-container="" data-clean-code="gcloud auth application-default set-quota-project {QUOTA_PROJECT}" data-astro-cid-4g3kud3p="">
...
### OAuth<a href="#oauth" class="deep-link-anchor" aria-label="Link to section">link</a>
...
<div class="code-container" data-code-container="" data-clean-code="https://antigravity.google/oauth-callback" data-astro-cid-4g3kud3p="">
...
### Custom Headers<a href="#custom-headers" class="deep-link-anchor" aria-label="Link to section">link</a>
...
## MCP Permissions and Access Control<a href="#mcp-permissions-and-access-control" class="deep-link-anchor" aria-label="Link to section">link</a>
...
## Supported MCP Servers<a href="#supported-mcp-servers" class="deep-link-anchor" aria-label="Link to section">link</a>
