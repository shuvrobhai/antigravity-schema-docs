...
final_url: "https://antigravity.google/docs/mcp"
fetched: 2026-08-13
status: 200
---
...
warningRemote Connection Schema: When declaring remote SSE, Streamable HTTP, or websocket-based MCP connections, you must define the serverUrl field. Legacy fields like url or httpUrl are not supported.
